...
namespace websitebenhvien.Migrations
{
    ...
    [Migration("20251024022738_guidecustomer")]
    partial class guidecustomer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("websitebenhvien.Models.Enitity.Activitycategory", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id_activitycategory"));
                    ...
                    b.Property<string>("link_alias")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id_activitycategory");
            ...
            modelBuilder.Entity("websitebenhvien.Models.Enitity.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("websitebenhvien.Models.Enitity.Forbusiness", b =>
                {
                    ...
                    b.Property<string>("Icon_Forbusiness")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("link_Forbusiness")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("link_Forbusiness_1")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("websitebenhvien.Models.Enitity.Menunav", b =>
                {
                    b.Property<int>("Id_menunav")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id_menunav"));

                    b.Property<int>("Id_titlemenu")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Id_titlemenu");

                    b.ToTable("Menunav", (string)null);
                });
            ...
            modelBuilder.Entity("websitebenhvien.Models.Enitity.Titlemenu", b =>
                {
                    b.Property<int>("Id_titlemenu")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id_titlemenu"));
                    ...
                    b.HasKey("Id_titlemenu");

                    b.ToTable("Titlemenu", (string)null);
                });
            ...
            modelBuilder.Entity("Websitebenhvien.Models.Enitity.Customerguide", b =>
                {
                    b.HasOne("websitebenhvien.Models.Enitity.Catogeryguider", "Catogeryguider")
                        ...
                        .HasForeignKey("Id_Customerguide")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("websitebenhvien.Models.Enitity.Menunav", b =>
                {
                    b.HasOne("websitebenhvien.Models.Enitity.Titlemenu", "Titlemenu")
                        .WithMany("TitlemenuList")
                        .HasForeignKey("Id_titlemenu")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
